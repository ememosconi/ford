package com.ford.msseed.archunit;
...
@AnalyzeClasses(packages = "com.ford.msseed", importOptions = ImportOption.DoNotIncludeTests.class)
public class LayeredArchitectureTest {
    ...
    public static final ArchRule layer_dependencies_are_respected = Architectures.layeredArchitecture()
            ...
            .layer(CONFIG).definedBy("com.ford.msseed.config..")
            .layer(DOMAIN).definedBy("com.ford.msseed.domain..")
            .layer(ADAPTERS).definedBy("com.ford.msseed.adapter..")
            .layer(APPLICATION).definedBy("com.ford.msseed.application..")
